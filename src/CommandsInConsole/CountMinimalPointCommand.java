...
// вывести количество элементов, значение поля minimalPoint которых равно заданному
    ...
    public boolean apply(String[] arguments) {
        try {
            ...
            if (arguments.length >= 2) {
                ...
                minimalPointString = askForMinPoint();  // запрос у пользователя
            }
            double minimalPoint = Double.parseDouble(minimalPointString); //Преобразование строки minimalPoint в число типа double
